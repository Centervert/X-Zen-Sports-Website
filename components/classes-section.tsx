...
const classes = [
  ...
  },
  {
    ...
    schedule: {
      Monday: ["5:30P – Bag Work/Conditioning", "7:30P – Techniques"],
      Tuesday: [
        "11:00A – Bag Work/Conditioning",
        "4:30P – Youth Boxing 6–13yrs",
        "5:30P – Bag Work/Conditioning",
        "7:30P – Techniques",
      ],
      Wednesday: ["5:30P – Bag Work/Conditioning", "7:30P – Techniques"],
      Thursday: [
        "11:00A – Bag Work/Conditioning",
        "4:30P – Youth Boxing 6–13yrs",
        "5:30P – Bag Work/Conditioning",
      ...
      Friday: ["4:30P – Bag Work/Conditioning"],
      Saturday: ["12:00P – Bag Work/Conditioning"],
    },
  },
  {
    id: "fitness",
    ...
    image: "/fitness-conditioning-class-modern-gym.jpg",
    icon: Dumbbell,
  ...
  },
  {
    ...
    image: "/kids-martial-arts-class.jpg",
    icon: Heart,
