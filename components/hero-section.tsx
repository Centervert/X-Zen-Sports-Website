        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          <div className={`${isLoaded ? "animate-hero-fade-in" : ""}`}>
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 max-w-4xl mx-auto drop-shadow-lg">
              Fight • Flow • Grow with expert training in Muay Thai, Boxing, Brazilian Jiu-Jitsu, Wrestling, and Fitness
              Conditioning
            </p>
          </div>
          ...
          <div className="mt-8">
            ...
            >
              <a
                href="https://onlinejoin.abcfitness.com/signup/plan?club=10089"
                target="_blank"
